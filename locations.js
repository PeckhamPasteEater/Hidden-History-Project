const locations = [
  ...
  },
  {
    ...
    image: "",
    longDescription: "Founded in 1948 with six employees and $22,000 in capital, Varian Associates was one of the first companies in the world to marry revolutionary science and commerce, setting precedents for the way in which many Silicon Valley companies operate today. In fact, many call its purchase of property in Stanford Resarch Park the birth of Silicon Valley. It was the first building in the park, which today is prime real estate for tech companies throughout the world looking to be at the forefront of technological advancement. Varian focussed primarily on the klystron, a tube used to amplify microwave frequencies, which the Varian siblings themselves had discovered prior to the incorporation of their firm. Their research was birthed out of Sigurd Varian's experiences as a pilot in the 1930s; amidst the rise of Nazi militarism, Sigurd was determined to develop a radio-based device to detect aircraft in flight. Their succeeding work on the klystron would, as such, be critical for radar technology in World War II. When they returned to Silicon Valley to establish their company, they knew they needed to be near Stanford. In 1953, they moved into the Park, an office in which technology critical for radiation therapy, MRI scanning, and linear accelerators would be developed. Although, in 1999, the company split into three, its legacy remains prominent. Varian Medical Systems, as acquired by Siemens, remains in the Park. Nowadays, as collaboration between education and the industry is commonplace, it is important to remember Varian as the practice's pioneer.",
    images: []
  },
  {
    id: "xerox_parc",
